...
if __name__ == "__main__":
    ...
    df.to_csv(os.path.join(save_str, model+"_rlcomp_he_base_low_temp_results_" + str(mcmc_steps) + "_" + str(temp) + "_" + str(args.batch_idx)  + "_" + str(args.seed) + ".csv"), index=False)
